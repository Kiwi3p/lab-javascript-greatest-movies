...
// Calc the average of those movies... we already have a function that finds average
...
const orderAlphabetically = (movies) => {
    let orderArray = [...movies].sort((movie1, movie2) => {
        if (movie1.title > movie2.title) {
            return 1;
        } else {
            return -1;
    ...
    return orderArray.map(movie => movie.title);
}

//aort for arrays
//if you are ordering string -> sort()
// if you are ordering numbers -> .sort( <function inside>)
// if you are ordering objects -> .sort( <function inside>)
